    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            t.exports = function (t, e, n, h, d, y, m) {
                ...
                if (
                    (N && (E = f(N.call(new t()))) !== Object.prototype && E.next && (s(E, w, !0), r || "function" == typeof E[l] || u(E, l, v)),
                    O &&
                        _ &&
                        "values" !== _.name &&
                        ((x = !0),
                    ...
                    if (((g = { values: O ? A : T("values"), keys: y ? A : T("keys"), entries: L }), m)) for (b in g) b in S || i(S, b, g[b]);
            ...
            var r = n(1),
                ...
                J = function (t, e, n) {
                    return (
                        ...
                        (e = T(e, !0)),
                        g(n),
                        o(F, e) ? (n.enumerable ? (o(t, P) && t[P][e] && (t[P][e] = !1), (n = O(n, { enumerable: w(0, !1) }))) : (o(t, P) || N(t, P, w(1, {})), (t[P][e] = !0)), B(t, e, n)) : N(t, e, n)
                    );
                },
                W = function (t, e) {
                    g(t);
            ...
            var l = (function () {
                function t(e, n) {
                    ...
                    if (
                        ...
                        f(this, "visibleNodeTypes", { HTML_TAG: "HTML_TAG", TEXT_NODE: "TEXT_NODE" }),
                        f(this, "state", {
                        ...
                        f(this, "options", { strings: null, cursor: "|", delay: "natural", loop: !1, autoStart: !1, devMode: !1, wrapperClassName: "Typewriter__wrapper", cursorClassName: "Typewriter__cursor" }),
                        ...
                        f(this, "typeOutHTMLString", function (t) {
                            ...
                            return n.length
                                ? ((e.innerText = ""),
                                  r.addEventToQueue(r.eventNames.ADD_HTML_TAG_ELEMENT, { htmlTagElement: e }),
                                  n.forEach(function (t) {
                                      r.addEventToQueue(r.eventNames.TYPE_CHARACTER, { character: t, htmlTagElement: e });
                                  }),
                                  r)
                                : r;
                        }),
                ...
                "Array",
                {
                    from: function (t) {
                        var e,
                            ...
                            m = 0,
                            g = f(p);
                        if ((y && (d = r(d, h > 2 ? arguments[2] : void 0, 2)), void 0 == g || (v == Array && a(g)))) for (n = new v((e = c(p.length))); e > m; m++) s(n, m, y ? d(p[m], m) : p[m]);
                        else for (l = g.call(p), n = new v(); !(o = l.next()).done; m++) s(n, m, y ? u(l, d, [o.value, m], !0) : o.value);
                        return (n.length = m), n;
                    },
                }
            );
        ...
        function (t, e, n) {
            for (
                ...
                var y,
                    ...
                    b = u[m],
                    E = b && b.prototype;
                if (E && (E[f] || a(E, f, p), E[l] || a(E, l, m), (c[m] = p), g)) for (y in r) E[y] || i(E, y, r[y], !0);
            }
        },
        function (t, e, n) {
            "use strict";
