...
.pauseFor(500)
    ...
    .deleteAll()
.pauseFor(500)
    .typeString('And a big one is the people you surround yourself with')
    .pauseFor(599)
    .deleteAll()
.pauseFor(500)
    ...
    .deleteAll()
.pauseFor(500)
    .typeString('A friend to share lighthearted laughs with our quirky humor and the deepest convos :D')
    .pauseFor(599)
    .deleteAll()
.pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString('Then of course, Dallas, and so much more!')
    .pauseFor(599)
    .deleteAll()
    .pauseFor(500)
