...
.typeString('This is a little rough but watch until the end (You can\'t tab out or it may break, so in one sitting!!)')
    ...
    .deleteAll()
.pauseFor(500)
    .typeString('I sometimes think how life put us all in 21a together that Fall semester')
    .pauseFor(599)
    .deleteAll()
.pauseFor(500)
    .typeString('It\'s really one of the things where I wonder: \"What if it didn\'t happen?\"')
    .pauseFor(599)
    .deleteAll()
.pauseFor(500)
...
.pauseFor(500)
    ...
    .deleteAll()
.pauseFor(500)
    .typeString('These past years have helped me realize there\'s so many more dimensions to life')
    .pauseFor(599)
    .deleteAll()
.pauseFor(500)
...
.pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString('But we have many years in the future for more memories.  I\'m super excited!')
    .pauseFor(599)
    .deleteAll()
    .pauseFor(500)
    .typeString('You flew in for my bday which was more than I could ask ever for, but I hope you enjoy this little thing for yours.  Thank you Staci :D')
    .pauseFor(599)
    .deleteAll()
    .pauseFor(500)
